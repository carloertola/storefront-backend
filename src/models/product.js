...
var ProductStore = /** @class */ (function () {
    ...
    ProductStore.prototype.index = function () {
        return __awaiter(this, void 0, void 0, function () {
            var conn, sql_query, result, err_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, conn.query(sql_query)];
                    case 2:
                        result = _a.sent();
                        conn.release();
    ...
    ProductStore.prototype.show = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            var sql_query, conn, result, err_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                        sql_query = 'SELECT * FROM product WHERE id=($1)';
                        return [4 /*yield*/, sql.connect()];
                    case 1:
                        conn = _a.sent();
                        return [4 /*yield*/, conn.query(sql_query, [id])];
                    case 2:
                        result = _a.sent();
                        conn.release();
    ...
    ProductStore.prototype.create = function (p) {
        return __awaiter(this, void 0, void 0, function () {
            var sql_query, conn, result, product, err_3;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                        sql_query = 'INSERT INTO product (name, price, category) VALUES($1, $2, $3) RETURNING *';
                        return [4 /*yield*/, sql.connect()];
                    case 1:
                        conn = _a.sent();
                        return [4 /*yield*/, conn.query(sql_query, [p.name, p.price, p.category])];
                    case 2:
                        result = _a.sent();
    ...
    ProductStore.prototype.delete = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            var sql_query, conn, result, product, err_4;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                        sql_query = 'DELETE FROM product WHERE id=($1)';
                        return [4 /*yield*/, sql.connect()];
                    case 1:
                        conn = _a.sent();
                        return [4 /*yield*/, conn.query(sql_query, [id])];
